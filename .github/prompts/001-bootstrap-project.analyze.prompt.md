---
name: 001-bootstrap.analyze
description: Analyze and audit the consistency of spec 001-bootstrap-project before execute implementation
---
...
- `.specify/specs/001-bootstrap-project/spec.md`
- `.specify/specs/001-bootstrap-project/plan.md`
...
- Scope creep beyond the objectives of Spec 001.
...
- Improvements that are not required for Spec 001.
